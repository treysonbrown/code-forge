...
const Menu = () => {
	...
	return (
		...
		<div ref={menuRef}>
			<button data-collapse-toggle="navbar-hamburger" type="button" onClick={hiddenChange} className="inline-flex items-center justify-center p-2 w-10 h-10 text-sm text-gray-500 rounded-lg hover:bg-local-primary focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-hamburger" aria-expanded="false">
